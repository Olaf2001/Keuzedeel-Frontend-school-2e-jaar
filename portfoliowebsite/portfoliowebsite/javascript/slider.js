...
var automatic;
var image = [];
image[1] = 'src="./portfoliowebsite/images/coding1.jpg" alt="Coderen"';
image[2] = 'src="./portfoliowebsite/images/website.jpg" alt="Website"';
image[3] = 'src="./portfoliowebsite/images/laptop.jpg" alt="Laptop"';
